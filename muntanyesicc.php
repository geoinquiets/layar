...
//
function Gethotspots( $db, $value, $type_requested = false ) {
...
*/
  ...
  $query = "
    		...
    		FROM icc_cim_indr_orogr_serra ".
                ($type_requested?"WHERE type IN(".implode($type_requested,",").")":"").
...
switch($profile) {
        ...
        case "2":
                // 10087 records
                $type_requested = array(1,16);
        break;
        case "3":
                // 4769 records
                $type_requested = array(1);
        break;
        default:
                //19876 records
                $type_requested = false;
...
try {
	...
	*/
	...
	$response["hotspots"] = Gethotspots( $db, $value, $type_requested );
